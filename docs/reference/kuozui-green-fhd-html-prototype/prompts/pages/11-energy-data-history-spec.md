# Page Spec: 能源資料歷史 / Energy Data History

## Part A: Source Visual Analysis

- Source: `11.Energy Data History.png`
- Canvas: source is 16:9 and normalized to 1920x1080.
- Archetype: history/chart
...
- Chart mapping: each chart region uses `ChartCard` with a static SVG `ChartPlot`, grid, axis, area, and line series.
