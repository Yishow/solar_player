...
The 2026-06-05 reference-informed batch fills this section per page in `docs/archive/reference-match/2026-06/fhd-playback-boundary-classification-2026-06-05.md` (run id `reference-informed-closeout`).
