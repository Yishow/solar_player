...
test("every display runtime metric resolves to exactly one policy category", () => {
  const expectedCategories = {
    ...
    "factoryCircuit.assemblyPower": "realtime",
    "factoryCircuit.bodyPower": "realtime",
    "factoryCircuit.edCoatingPower": "realtime",
    "factoryCircuit.heavyVehiclePower": "realtime",
    "factoryCircuit.officePower": "realtime",
    "factoryCircuit.paintingPower": "realtime",
    "factoryCircuit.stampingPower": "realtime",
    "factoryCircuit.utilityPower": "realtime",
    "factoryGeneration.monthMwh": "cumulative",
    "factoryGeneration.todayMwh": "daily",
    "factoryGeneration.totalMwh": "cumulative",
