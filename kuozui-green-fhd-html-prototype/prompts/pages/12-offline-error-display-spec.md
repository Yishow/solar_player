# Page Spec: 無法取得即時資料 / Offline Error Display

## Part A: Source Visual Analysis

- Source: `12.Offline Error Display.png`
...
|---|---:|---:|---:|---:|---:|---|---|---|
| .topbar | 42 | 26 | 1836 | 72 | 5 | Kiosk header with logo/time/status | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .brand-logo | 42 | 38 | 46 | 46 | 5 | Supplied logo in white holder | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .brand-name | 102 | 38 | 190 | 42 | 5 | Brand Chinese and English | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .system-title | 372 | 38 | 420 | 42 | 5 | System bilingual title | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .header-time | 1240 | 32 | 88 | 42 | 5 | Clock display | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .header-date-weather | 1346 | 42 | 220 | 24 | 5 | Date and weather | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .header-mqtt-pill | 1635 | 38 | 140 | 36 | 5 | MQTT status pill | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .content-hard-safe-zone | 0 | 126 | 1920 | 838 | 5 | Main content area above footer | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .content-visual-safe-zone | 0 | 126 | 1920 | 818 | 5 | Visual safe zone above footer gap | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer | 42 | 984 | 1836 | 72 | 5 | Bottom navigation | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-slide-indicator | 42 | 1008 | 46 | 24 | 5 | Page number pill | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-overview | 600 | 1000 | 90 | 38 | 5 | Overview navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-solar | 732 | 1000 | 70 | 38 | 5 | Solar navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-circuit | 840 | 1000 | 130 | 38 | 5 | Factory Circuit navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-image | 1010 | 1000 | 70 | 38 | 5 | Image navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-sustainability | 1120 | 1000 | 130 | 38 | 5 | Sustainability navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-nav-settings | 1292 | 1000 | 90 | 38 | 5 | Settings navigation link | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .footer-note | 1600 | 1008 | 278 | 24 | 5 | Footer operational note | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-bg | 560 | 198 | 1190 | 590 | 5 | Error background media | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-alert-icon | 575 | 300 | 70 | 70 | 5 | Alert DisplayHeroIcon | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-title | 320 | 420 | 620 | 50 | 5 | Error message | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-subtitle | 320 | 476 | 620 | 28 | 5 | English error message | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-explainer | 410 | 526 | 440 | 52 | 5 | Retry copy | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-panel | 320 | 320 | 620 | 358 | 5 | Error message panel | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-detail-table | 410 | 602 | 440 | 132 | 5 | Error detail rows | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
| .offline-retry | 642 | 826 | 630 | 44 | 5 | Retry notice | page-specific absolute region | maps to `styles/pages/12-offline-error-display.css` |
...
Task: build a source-grounded 1920x1080 HTML/CSS/limited-JS replica for `無法取得即時資料 / Offline Error Display`. This is not a redesign, not a similar-style dashboard, and not a generic website. The source file is `12.Offline Error Display.png` and the page archetype is `status/error`.
