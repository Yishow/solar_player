...
- [ ] 1.1 **Contracts** — 建立observation/reception/capture/candidate shared types及metadata schema，交付 **Observations exist independently of metric mappings**。（M1-R1 M1-R5 M1-R10）
