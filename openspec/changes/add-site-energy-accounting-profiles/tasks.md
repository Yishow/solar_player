...
2026-09-07：完成 preview snapshot 不可變性與 calculator 失敗不留 token 的局部修復；1.5 尚缺 source revision review context 與數值整合，保持未勾選。證據與待釐清契約見 [preview snapshot 修復記錄](./preview-snapshot-20260907.md)。

2026-09-07：1.13 已完成並通過最後版 pnpm verify；UI 維持既有操作步驟。完整來源 review 證據、已修正的 build 問題與剩餘 E2/E6 邊界見 [來源版本檢查記錄](./source-review-20260907.md)。
