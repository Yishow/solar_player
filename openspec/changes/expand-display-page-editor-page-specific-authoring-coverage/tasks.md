...
- [ ] 1.2 Deliver `Replace coverage gaps with page-specific region schemas` by ensuring unsupported pages no longer rely on the generic fallback message once schema coverage is added, and verify through targeted editor rendering assertions.
