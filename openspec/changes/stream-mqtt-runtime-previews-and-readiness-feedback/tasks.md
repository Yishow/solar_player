...
- [ ] 1.2 Deliver `Drive MQTT runtime preview from live updates instead of coarse polling` by defining the merge/fallback behavior between bootstrap reload and live preview updates, and verify with `apps/web/src/pages/MqttSettings/viewModel.test.ts` cases for live, idle, and disconnected topics.
