...
- 只處理 `docs/archive/reference-match/2026-05/all-pages-audit.md` 中的 settings / management form-heavy pages：`/settings/playback`、`/settings/images`、`/settings/mqtt`、`/settings/circuits`。
