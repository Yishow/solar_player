...
- [x] 2.2 Deliver `Keep fault triage semantics consistent across management surfaces` with regression coverage, and verify using `pnpm --filter @solar-display/web test -- src/pages/OfflineError/*.test.ts src/pages/DeviceStatus/*.test.tsx src/pages/PlaybackSettings/*.test.ts`.
