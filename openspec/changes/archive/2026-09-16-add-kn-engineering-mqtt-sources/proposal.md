...
無直接修改正式主規格。本提交同時修訂 A–F 的 active artifacts；關聯變更 plan-power-mqtt-publishing-and-kn-onboarding 只負責 KN 啟用關卡，細節以本 change 兩個能力為唯一依據。不得讓兩份 change 重複修改相同 requirement。
