...
- [x] 2.3 若 fresh witness 顯示 Overview media quality 需要現有 controls 以外的能力，將該項記錄為 `actual-gap` follow-up，交付 `Actual Gaps Become Follow-Up Work` 的 handoff；完成後以 `rg "actual-gap|Overview" docs/archive/reference-match/2026-06/overview-solar-reference-quality-closeout.md` 驗證。
...
- [x] 3.3 若 fresh witness 顯示 Solar connector stroke、cap 或 node treatment 無法由現有 fields 表達，將該項記錄為 `actual-gap` follow-up，交付 `Actual Gaps Become Follow-Up Work` 的 separate editor capability handoff；完成後以 `rg "actual-gap|Solar" docs/archive/reference-match/2026-06/overview-solar-reference-quality-closeout.md` 驗證。

## 4. Evidence And Gates

- [x] 4.1 建立 `docs/archive/reference-match/2026-06/overview-solar-reference-quality-closeout.md`，交付 before/after witness notes、protected shell confirmation、actual-gap notes；完成後以 `rg "Overview|Solar|protected-product-choice|reference-quality-target|actual-gap" docs/archive/reference-match/2026-06/overview-solar-reference-quality-closeout.md` 驗證。
