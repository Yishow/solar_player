...
- [x] 2.3 將 classification artifact 的 follow-up 欄位對應到後續四個 page closeout changes，交付 downstream handoff；完成後以 `rg "polish-overview-solar-reference-quality-targets|polish-factory-circuit-reference-quality-targets|polish-images-reference-quality-targets|polish-sustainability-reference-quality-targets" docs/archive/reference-match/2026-06/fhd-playback-boundary-classification-2026-06-05.md` 驗證。
