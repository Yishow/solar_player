...
- [ ] 2.2 Deliver `Distinguish immediate refresh from deferred draft conflicts` with regression coverage, and verify using `pnpm --filter @solar-display/web test -- src/pages/managementDisplaySync.test.ts`.
