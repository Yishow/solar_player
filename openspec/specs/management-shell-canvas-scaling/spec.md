# management-shell-canvas-scaling Specification

## Purpose

TBD - created by archiving change 'unify-management-shell-canvas-scaling'. Update Purpose after archive.
...
<!-- @trace
source: unify-management-shell-canvas-scaling
updated: 2026-05-24
code:
