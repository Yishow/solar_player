# engineering-period-results Specification

## Purpose

Specify the storage, revision tracking, correction, withdrawal, bounded backfill, period aggregation, and accounting profile integration for Guanyin engineering daily interval energy reports.
...
<!-- @trace
source: add-kn-engineering-mqtt-sources
updated: 2026-09-16
code:
...
- **THEN** the sum can be zero but ratios remain unavailable with a zero-basis reason
