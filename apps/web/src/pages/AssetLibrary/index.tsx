      ...
      <div className="grid gap-4 lg:grid-cols-[1.25fr_0.9fr]">
            ...
            {filteredAssets.map((asset) => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <div className="text-[15px] font-semibold text-[var(--shell-title-ink)]">
        ...
        <section className="rounded-[24px] border border-[var(--shell-divider)] bg-white/85 p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              disabled={selectedAssetId === null || isDeleting}
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="rounded-[18px] border border-[var(--shell-divider)] p-4">
                ...
                <div className="mt-3 space-y-2">
                  {assetReferences?.references.length ? assetReferences.references.map((reference) => (
