...
test("factory load rows and routing use shared display-family surface and token roles", () => {
  ...
  assert.doesNotMatch(factorySource, /factory-routing-inverter-board-reference\.png/);
  assert.doesNotMatch(factorySource, /factory-routing-inverter-drop-reference\.png/);
  assert.doesNotMatch(factorySource, /factory-routing-load-reference\.png/);
  assert.doesNotMatch(factorySource, /function FactoryCircuitRoutingReference/);
