...
export function createFactoryCircuitDisplayPageSeedConfig(): FactoryCircuitDisplayPageConfig {
  return {
    ...
    connectorTreatments: {
      inverterToBoard: createFlowConnectorTreatmentConfig({ strokeColor: "#6f9b5a", strokeWidth: 3, zIndex: 9 }),
      solarToInverter: createFlowConnectorTreatmentConfig({ strokeColor: "#6f9b5a", strokeWidth: 3, zIndex: 9 })
    },
    connectors: {
