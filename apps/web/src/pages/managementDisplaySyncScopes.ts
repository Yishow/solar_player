...
export const MQTT_SETTINGS_DISPLAY_SYNC_SCOPES = defineDisplaySyncScopes(["mqtt", "playback", "weather"]);

export const CIRCUIT_SETTINGS_DISPLAY_SYNC_SCOPES = defineDisplaySyncScopes(["circuits", "playback"]);
